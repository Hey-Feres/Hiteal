		...
		def inputs_attributes
			@inputs_attributes = {
				...
				fichas: {
					...
					exercicio: {
						label: "Exercicio",
						select_id: "fichas-exercicio",
						options: Exercicio.all.map{|exercicio| { title: exercicio.nome, value: exercicio.id } }
					},
					series: {
						label: "Séries",
						placeholder: "Séries",
						input_id: "fichas-series",
					},
					repeticoes: {
						label: "Repetições",
						placeholder: "Repetições",
						input_id: "fichas-repeticoes",
					}
				}			
			}
		end
